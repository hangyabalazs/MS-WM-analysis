function stat_panel_fig3(resdir, cleaned_data, varargin)
%STAT_PANEL_FIG3 Generates statistical panel figures in Fig3.
%   STAT_PANEL_FIG3(RESDIR, CLEANED_DATA) compares experimental and control data 
...
%  2025
    ...
    fnm = [resdir '\' 'Stat panel - fig3.jpg'];
    saveas(gcf, fnm)
    
    fnmm = [resdir '\' 'Stat panel - fig3.svg'];
    saveas(gcf, fnmm)
